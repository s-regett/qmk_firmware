...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC,                        KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    WIN,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MINS,                        KC_EQL , KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
    KC_GRV,  LCTL_A,  LALT_S,  LGUI_D,  LSFT_F,  KC_G,    KC_DEL ,                        KC_BSPC, KC_H,    RSFT_J,  RGUI_K,  RALT_L,  RCTL_SCLN,KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME ,                       KC_END , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    SUPA,    KC_LCTL, KC_LALT, KC_LGUI,          LOWER,   KC_SPC ,KC_BSPC,         KC_ENT,KC_SPC , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TILD, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_COLN, KC_DQT ,
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_HOME ,                       KC_END , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT,
    KC_LCTL, KC_LALT, KC_LGUI, SUPA,             LOWER,   KC_SPC ,KC_BSPC,         KC_ENT,KC_SPC , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),
  ...
  [_WIN] = LAYOUT(
    ...
    KC_GRV,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME ,                       KC_END , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, SUPA,             LOWER,   KC_SPC ,KC_BSPC,         KC_ENT,KC_SPC , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
};
